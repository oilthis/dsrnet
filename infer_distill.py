...
def main():
    ...
    parser.add_argument('--dataset', default='TestSet2', type=str, help='TestGuanDao')
    ...
    parser.add_argument('--testset', default='TestSet3', type=str, help='Sun80 | Urban100 | TestSet_multi')
    parser.add_argument('--save_folder', default='./sr_distill/', type=str)
