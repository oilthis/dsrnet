...
def main():
    ...
    ## dataloader setting
    parser.add_argument('--data_root', default='/home/NewHDD/wc/',type=str)
    parser.add_argument('--dataset', default='GuanDao', type=str, help='GuanDao')
    parser.add_argument('--testset', default='TestGuanDao', type=str, help='TestGuanDao')
    ...
    parser.add_argument('--lambda_dep', default=0.01, type=float)
    ...
    parser.add_argument('--resume_unet', default='', type=str)

    ## log setting
    parser.add_argument('--log_freq', default=10, type=int)
    parser.add_argument('--vis_freq', default=50, type=int) #50000
    ...
    parser.add_argument('--t_resume', default='', type=str)
    parser.add_argument('--loss_kd', action='store_true')
    parser.add_argument('--loss_ad', action='store_true')
    parser.add_argument('--lambda_kd', default=0.5, type=float)
    parser.add_argument('--lambda_ad', default=1, type=float)
    # parser.add_argument('--t_resume_optim', default='', type=str)
    # parser.add_argument('--t_resume_scheduler', default='', type=str)
    # parser.add_argument('--t_resume_unet', default='', type=str)
