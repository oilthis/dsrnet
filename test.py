...
def main():
    ...
    parser.add_argument('--name', default='dsrnet', type=str)
    ...
    parser.add_argument('--dataset', default='TestGuanDao', type=str, help='TestGuanDao')
    parser.add_argument('--crop_size', default=256, type=int)
    parser.add_argument('--batch_size', default=1, type=int)
    parser.add_argument('--num_workers', default=4, type=int)
    parser.add_argument('--data_augmentation', default=False, type=bool)
    
    parser.add_argument('--resume', default='./pretrained_weights/dsrnet+.pth', type=str)
    parser.add_argument('--testset', default='TestGuanDao', type=str, help='Sun80 | Urban100 | TestSet_multi')
